...
(function () {
  ...
  var getSuffix = function (number, titles) {
    var titleIndex = (number % 100 > NumberValue.MIN_FOR_MORE_THAN_HUNDRED && number % 100 < NumberValue.MAX_FOR_MORE_THAN_HUNDRED) ? 2 : INDEXES_FOR_LESS_THAN_HUNDERT[(number % 10 < NumberValue.MAX_FOR_MORE_THAN_HUNDRED) ? number % 10 : 5] ;
